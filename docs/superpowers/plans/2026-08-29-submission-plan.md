...
- [ ] **9/4·9/5: `FEEDERS=default` 로 수집** (런북 T8에 반영). 모델 입력엔 **안 씀** — 관측만
- [ ] **9/6: 검증** — 피더 30분 초과 승차(OA-12921 토 중앙값 대비) vs 여의나루+여의도 핫스팟 30분 하차, 랙 5~60분 교차상관 → 최적 랙·r 을 오차표 옆 "선행지표 검증" 절로. 좋으면 확장안이 아니라 검증 결과로 제출
